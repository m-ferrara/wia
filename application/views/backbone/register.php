...
<div class="row">
  <label for="password">First Name: <input type="text" name="firstName" placeholder="First Name" /></label>
</div>  

<div class="row">
  <label for="password">Last Name: <input type="text" name="lastName" placeholder="Last Name" /></label>
</div>  
