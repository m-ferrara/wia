...
class Citation_model extends CI_Model
{
   ...
   function citations_get()
  {
    ...
    return $getDbResult->result_array();
  }
  ...
  function citation_put($cit_id, $author, $source, $source_secondary, $pub_yr, $pub_date, $title, $isbn_id, $cit_desc, $internet_address, $pages)
  {
    $putArray = array(
